...
<html>
  ...
  <body style="background:#f7fcfe">
    ...
    <div class="lesson-wrapper-2" style="margin:0  auto;  width:90%;  margin-bottom:10%;">
      ...
      <div class="lesson-wrapper-9" style="float:left;margin-top:6%;  color:#192f60;">
        ...
        <div class="lesson-wrapper-10" style="padding-top:20%">
          ...
          <div class="lesson-wrapper-3" style=" float:left; ">
            ...
            <p style="font-size:17px; padding-bottom:20px;"><a href="#">東京都葛飾区鎌倉3-58-2</a></p>
